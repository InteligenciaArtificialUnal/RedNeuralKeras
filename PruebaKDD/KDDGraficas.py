...
def ejecutarPrograma(opcion):
    ...
    '''
    path = 'C:\Users\Daniel\Documents\Unal\Maestria_2017_2\Inteligentes\Entregas\Entrega2\implementacion\datos'
    documents = []
    titles = []
    ...
    cosine = cosine_similarity(tfidf_matrix[0:1], tfidf_matrix[1:2])
    print cosine
